...
def load_conv(buf, start, conv_model):
    ...
    conv_model.bias.data.copy_(torch.from_numpy(buf[start:start+num_b]), broadcast=False);   start = start + num_b
    conv_model.weight.data.copy_(torch.from_numpy(buf[start:start+num_w]), broadcast=False); start = start + num_w
    return start
...
def load_conv_bn(buf, start, conv_model, bn_model):
    ...
    bn_model.bias.data.copy_(torch.from_numpy(buf[start:start+num_b]), broadcast=False);     start = start + num_b
    bn_model.weight.data.copy_(torch.from_numpy(buf[start:start+num_b]), broadcast=False);   start = start + num_b
    bn_model.running_mean.copy_(torch.from_numpy(buf[start:start+num_b]), broadcast=False);  start = start + num_b
    bn_model.running_var.copy_(torch.from_numpy(buf[start:start+num_b]), broadcast=False);   start = start + num_b
    conv_model.weight.data.copy_(torch.from_numpy(buf[start:start+num_w]), broadcast=False); start = start + num_w 
    return start
